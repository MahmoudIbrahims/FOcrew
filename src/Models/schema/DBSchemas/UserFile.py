...
#     file_type = Column(String(10), nullable=False)  
#     file_size = Column(Integer, nullable=False) 
#     file_path = Column(String(1000), nullable=False)   # مكان الملف (filesystem/S3)

#     rows_count = Column(Integer, nullable=True)  
#     columns_count = Column(Integer, nullable=True)  
#     columns_info = Column(JSON, nullable=True)   # لو CSV/Excel ممكن تخزن info عن الأعمدة
#     sample_data = Column(JSON, nullable=True)    # عينة صغيرة بس مش الملف كله
