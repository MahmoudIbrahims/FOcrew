...
class ReportSenderAgent(BaseAgent):
    def __init__(self):
        ...
        super().__init__(
            ...
            goal="Send generated reports to managers via Gmail",
            backstory="\n".join([
                "You are responsible for delivering analysis results to stakeholders.",
                "You send the final reports automatically to managers using Gmail SMTP."
            ]),
            llm=llm,
    ...
    def get_task(self):
        return Task(
            description="\n".join([
                ...
                "this is Gmail and send it to managers automatically."
            ]),
